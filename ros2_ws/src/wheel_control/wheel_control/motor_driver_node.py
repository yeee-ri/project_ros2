...
class MotorDriverNode(Node):
    ...
    def cmd_vel_callback(self, msg):
        ...
        w1 = (-0.5 * vx + 0.866 * vy + ROBOT_RADIUS * wz) / WHEEL_RADIUS
        w2 = (-0.5 * vx - 0.866 * vy + ROBOT_RADIUS * wz) / WHEEL_RADIUS
        w3 = (1.0 * vx + 0.0 * vy + ROBOT_RADIUS * wz) / WHEEL_RADIUS
    ...
    def update_odom(self):
        ...
        vx = (2.0 / 3.0) * v3 - (1.0 / 3.0) * v1 - (1.0 / 3.0) * v2
        vy = (1.0 / math.sqrt(3.0)) * (v1 - v2)
